...
extern "C"
{
    /** @addtogroup F769I_BikeVERY_LOW_LEVEL_BUTTON STM32F769I Discovery Low Level Button
      * @{
      */
...
#define BUTTON_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()
    ...
    /** @brief Button_TypeDef
      *  F769I_BikeVERY board Buttons definitions.
      */
    typedef enum
    {
        BUTTON_WAKEUP = 0,
    ...
    /** @brief ButtonMode_TypeDef
      *  F769I_BikeVERY board Buttons Modes definitions.
      */
    typedef enum
    {
        BUTTON_MODE_GPIO = 0,
